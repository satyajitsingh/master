...
var _accessibleAutocomplete = require('accessible-autocomplete');

var _accessibleAutocomplete2 = _interopRequireDefault(_accessibleAutocomplete);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var calculateFieldService = require('../services/calculate-field');
 ...
 * dependent fields
 */
var updatePercentageSpend = function updatePercentageSpend() {
 ...
 * dependent fields
 */
var updatePercentageHours = function updatePercentageHours() {
 ...
 */
var initPercentageSpendCalculatedField = function initPercentageSpendCalculatedField() {
  calcSpendGroup.style.display = 'none';
 ...
 */
var initPercentageHoursCalculatedField = function initPercentageHoursCalculatedField() {
  calcHoursGroup.style.display = 'none';
  // Configure event listeners on dependent fields
 ...
 */
var updateOrganisationSuggestions = function updateOrganisationSuggestions(query, populateResults) {
 ...
 */
var organisationSelected = function organisationSelected(selection) {
 ...
 */
var suggestItemTemplate = function suggestItemTemplate(org) {
...
},{"../services/calculate-field":2,"accessible-autocomplete":4}],2:[function(require,module,exports){
'use strict';
...
module.exports = {
   ...
   * @returns {string}
   */
  parseCurrency: function parseCurrency(currency) {
   ...
   * @returns {float}
   */
  percentageSpend: function percentageSpend(pay, cost) {
    ...
    if (validator.currency(p) === true && validator.currency(c) === true) {
      ...
      var payC = currency(p);
      var costC = currency(c);
      // Calculate percentage to decimal points
      var calc = (costC / payC * 100).toFixed(2);
      // Return if sensible
   ...
   * @returns {float}
   */
  percentageHours: function percentageHours(facility, activities) {
...
},{"../utils/validator":3,"currency.js":5}],3:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  currency: currency,
  max4DigitsNumber: max4DigitsNumber,
  xlessthanyCheck: xlessthanyCheck,
  moreThanZero: moreThanZero,
  notInfinity: notInfinity,
...
function wholeNumber(value) {
  var regex = /^((0|[1-9]{1}\d{0,2},(\d{3},)*\d{3})|([1-9]{1}\d{0,}))$/;
  return regex.test(value);
}
